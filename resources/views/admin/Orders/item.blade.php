                        ...
                        <!-- Plugin content:powerpoint,txt,pdf,png,word,xl -->
                           <div class="btn-group">
                              <div class="buttonexport" id="buttonlist"> 
                                   <a class="btn btn-add" href="{{url('order')}}"> <i class=""></i> Order Detail List
                                 </a>  <br><br>
                              </div>
...
<!-- End Delete Modal -->               <?php 
                                            $deliverycharges = 150;
                                            $total_amount = $total_amount + ($orderitem->price*$orderitem->quantity); 
                                          ?>
                                  </tr>@endforeach 
                                  <tr>
                                     <th class="text-center text-danger" colspan="5" >Grand_Total</th>

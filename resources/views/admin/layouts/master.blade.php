               ...
               <ul class="sidebar-menu">
                  ...
                  <li class="treeview">
                     ...
                     <ul class="treeview-menu">
                        <li><a href="{{url('addCategories')}}">Add Categories</a></li>
                        <li><a href="{{url('category')}}">List</a></li>
                   ...
                   <li class="treeview">
                     ...
                     <ul class="treeview-menu">
                        ...
                        <li><a href="{{url('listProducts')}}">List</a></li>
                        
                     </ul>
                  </li>
                  <li class="treeview">
                     <a href="#">
                     <i class="fa fa-users"></i><span>Resturants</span>
                     <span class="pull-right-container">
                     <i class="fa fa-angle-left pull-right"></i>
                     </span>
                     </a>
                     <ul class="treeview-menu">
                     <li>
                        <a href="{{url('addResturants')}}">Add Resturants</a>
                     </li>
                        <li><a href="resturant">List</a></li>
                  ...
                  <li class="treeview">
                     <a href="#">
                     <i class="fa fa-users"></i><span>Delivery Boys</span>
                     <span class="pull-right-container">
                     <i class="fa fa-angle-left pull-right"></i>
                     </span>
                     </a>

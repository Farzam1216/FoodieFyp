            ...
            <div class="row">
                <div class="col-lg-4 col-sm-12">
                    <div class="contact-info-left">
                        <h2>CONTACT INFO</h2>
                        <p>If you have any quiry you can ask im the comment section given below </p>
                        <ul>
                            <li>
                                <p><i class="fas fa-map-marker-alt"></i>Address:Street no 2, Block j <br>City Housing,<br>Jhelum</p>
                            </li>
                            <li>
                                <p><i class="fas fa-phone-square"></i>Phone: <a href="tel:+1-888705770">+92 315 5700102     +92 307864229</a></p>
                            </li>
                            <li>
                ...
                <div class="col-lg-8 col-sm-12">
                    <div class="contact-form-right">
                        <h2>GET IN TOUCH</h2>
                        <p>You can easily ask question/quries in the comment section given below</p>
                        <form id="contactForm">
                            <div class="row">
                                <div class="col-md-12">

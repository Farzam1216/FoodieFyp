                                ...
                                <div role="tabpanel" class="tab-pane fade show active" id="grid-view">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-6 col-md-6 col-lg-4 col-xl-4">
                                            <div class="products-single fix">
                                                <div class="box-img-hover">
                                                    <img src="pics/chickentika.jpg" style="height: 350px " class="img-fluid" alt="Image">
                                                    <div class="mask-icon">
                                                        <a class="cart" href="#">Add to Cart</a>
                                                    </div>
                                                </div>
                                                <div class="why-text">
                                                    <h4>Chicken Tikka Boti</h4>
                                                    <h5> Rs 150 </h5>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-sm-6 col-md-6 col-lg-4 col-xl-4">
                                            <div class="products-single fix">
                                                <div class="box-img-hover">
                                                    <img src="pics/seekh kabab.jpg" style="height: 350px " class="img-fluid" alt="Image">
                                                    <div class="mask-icon">
                                                        <a class="cart" href="#">Add to Cart</a>
                                                    </div>
                                                </div>
                                                <div class="why-text">
                                                    <h4>Chicken Seekh Kabab 12</h4>
                                                    <h5> Rs 650</h5>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-sm-6 col-md-6 col-lg-4 col-xl-4">
                                            <div class="products-single fix">
                                                <div class="box-img-hover">
                                                    ...
                                                    <img src="pics/pulaoimg.jpg" style="height: 350px " class="img-fluid" alt="Image">
                                                    <div class="mask-icon">
                                                    <a class="cart" href="#">Add to Cart</a>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="col-sm-6 col-md-6 col-lg-4 col-xl-4">
                                            <div class="products-single fix">
                                                <div class="box-img-hover">
                                                    <img src="pics/fpro1.jpg" style="height: 350px " class="img-fluid" alt="Image">
                                                    <div class="mask-icon">
                                        ...
                                        <div class="col-sm-6 col-md-6 col-lg-4 col-xl-4">
                                            <div class="products-single fix">
                                                <div class="box-img-hover">
                                                    <img src="pics/img1.jpg" style="height: 350px " class="img-fluid" alt="Image">
                                                    <div class="mask-icon">
                                        ...
                                        <div class="col-sm-6 col-md-6 col-lg-4 col-xl-4">
                                            <div class="products-single fix">
                                                <div class="box-img-hover">
                                                    <img src="pics/daalmaash.jpg" style="height: 350px "class="img-fluid" alt="Image">
                                                    <div class="mask-icon">
                                                        <a class="cart" href="#">Add to Cart</a>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="col-sm-6 col-md-6 col-lg-4 col-xl-4">
                                            <div class="products-single fix">
                                                <div class="box-img-hover">
                                                    ...
                                                    <img src="pics/c1img.jpg" style="height: 350px "class="img-fluid" alt="Image">
                                                    <div class="mask-icon">
                                        ...
                                        <div class="col-sm-6 col-md-6 col-lg-4 col-xl-4">
                                            <div class="products-single fix">
                                                <div class="box-img-hover">
                                                    ...
                                                    <img src="pics/qeema.jpg" style="height: 350px "class="img-fluid" alt="Image">
                                                    <div class="mask-icon">
                                                        <a class="cart" href="#">Add to Cart</a>
                                                    </div>
                                                </div>
